...
def get_all_trajectories():
                                ...
                                while crossed == False:
                                    ...
                                    if ok == True:
                                        ...
                                        if distance_1 < 0.7:
                                            ...
                                            cross_correlation = get_cross_correlation(speed_2_x, speed_2_y, speed_1_x, speed_1_y, index_1)
                                            if who_leader == 2:
    ...
    with open(r"TimeLockedCorrelationTrajectories.pickle", "wb") as output_file:
...
with open(r"TimeLockedCorrelationTrajectories.pickle", "rb") as input_file:
...
def plot_condition_trajectories(ax, distance_trajectories, parameters):
    ...
    for pair in unique_pairs:
        ...
        ax.plot(x, mean_first_trajectories, color = 'orange', linestyle = '-', alpha = 0.4, linewidth = 1)
